...
public class DepressionScore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_depression_score);
        ...
        activity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DepressionScore.this, Depression.class);
                DepressionScore.this.startActivity(intent);
                DepressionScore.this.finish();
