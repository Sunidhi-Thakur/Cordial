...
public class DepressionYoga extends AppCompatActivity  implements MediaPlayer.OnPreparedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_depression_yoga);
        ...
        storageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                try {
                    ...
                    mediaPlayer1.setOnPreparedListener(DepressionYoga.this);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(DepressionYoga.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        pBar.setVisibility(View.GONE);
                    }
                });
        ...
        storageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                try {
                    ...
                    // wait for media player to get prepare
                    mediaPlayer2.setOnPreparedListener(DepressionYoga.this);
