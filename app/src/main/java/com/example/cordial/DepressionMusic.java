...
public class DepressionMusic extends AppCompatActivity implements MediaPlayer.OnPreparedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_depression_music);
    ...
    private void fetchAudioUrlFromFirebase1() {
        ...
        StorageReference storageRef = storage.getReferenceFromUrl("gs://health-project-9c67b.appspot.com/depression_removal.mp3");
        storageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                try {
                    ...
                    mediaPlayer1.setOnPreparedListener(DepressionMusic.this);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(DepressionMusic.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        pBar.setVisibility(View.GONE);
                    }
                });
    ...
    private void fetchAudioUrlFromFirebase2() {
        final FirebaseStorage storage = FirebaseStorage.getInstance();
        // Create a storage reference from our app
        StorageReference storageRef = storage.getReferenceFromUrl("gs://health-project-9c67b.appspot.com/requiem.mp3");
        storageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {
                try {
                    ...
                    // wait for media player to get prepare
                    mediaPlayer2.setOnPreparedListener(DepressionMusic.this);
    ...
    private void fetchAudioUrlFromFirebase3() {
        final FirebaseStorage storage = FirebaseStorage.getInstance();
        // Create a storage reference from our app
        StorageReference storageRef = storage.getReferenceFromUrl("gs://health-project-9c67b.appspot.com/somewhere.mp3");
        storageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {
                try {
    ...
    private void fetchAudioUrlFromFirebase4() {
        final FirebaseStorage storage = FirebaseStorage.getInstance();
        // Create a storage reference from our app
        StorageReference storageRef = storage.getReferenceFromUrl("gs://health-project-9c67b.appspot.com/lullaby.mp3");
        storageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {
                try {
    ...
    private void fetchAudioUrlFromFirebase5() {
        final FirebaseStorage storage = FirebaseStorage.getInstance();
        // Create a storage reference from our app
        StorageReference storageRef = storage.getReferenceFromUrl("gs://health-project-9c67b.appspot.com/chopin.mp3");
        storageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {
                try {
